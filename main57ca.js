...
const sttaddr = "0x04221d1995f679ec688f6ec108f1c9610e44f094";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
function getreflink() {
    document.getElementById('refaddresscopy').value = 'https://deskcoin.net/?ref=' + document.getElementById('refaddress').value;
}
